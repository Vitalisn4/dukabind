...
At the M6 freeze (2026-08-11) the measured participant output was snapshotted into `benchmarks/submission.json` (committed, un-ignored) — the freeze-dated artifact referenced by `CHANGELOG.md`.
