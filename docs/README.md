...
Root also ships [`BENCHMARKS.md`](../BENCHMARKS.md) (measured profiler numbers only) and `benchmarks/submission.summary.md`.

Strategy phases, roadmaps, progress logs, and stage scratch notes stay **local only** (see `.gitignore`) so the public repo remains submission-focused.
