...
Source: `benchmarks/raw/thermal_soak_20260806T071704Z.csv`, from `bash scripts/thermal_soak.sh` (default 10 min, sample 5 s). All 75 completions succeeded.
...
Source: `benchmarks/raw/thermal_soak_20260806T133807Z.csv`, from `THREADS=2 SOAK_MINUTES=10 bash scripts/thermal_soak.sh`. 69 completions, http 100%.
...
Source: `benchmarks/raw/thermal_soak_20260806T213423Z.csv`, from `THREADS=2 CTX=1024 SOAK_MINUTES=10 bash scripts/thermal_soak.sh`. 68 completions, http 100%, idle baseline 73 °C.
